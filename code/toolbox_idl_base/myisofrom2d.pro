function myisofrom2d,field,xgrid,ygrid,iso
;
...
fielxm=0. & fielxp=0. & fieldxseg(xcross)=1
...
fielym=0. & fielyp=0. & fieldyseg(ycross)=1
...
;
; Extension du vecteur des points isocontour
