function mynino4,field,xgrid,ygrid
compile_opt hidden
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
; retourne indice nino4 de field
;  Sulian Thual 2011
;
; INPUT PARAMETERS :
;
...
; rq: peut aussi utiliser myswitch, myfindcoord(/range) et mymean(/NaN) pour faire cette operation:
; - field=myswitch(field,[3,4,1,2]) par exemple pour mettre x et y a la fin
; - iy=myfindcoord([-5.,-5],ygrid,/range) pour voir partie y dans range boite
; - field=mymean(field(*,*,*,iy),/NaN; avg y
; - ix=myfindcoord([150.,210.],xgrid,/range) pour voir partie x dans range boite
; - field=mymean(field(*,*,ix,/NaN); avg x
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
imin=myfindcoord(150.,xgrid) & imax=myfindcoord(210.,xgrid)
...
print,'mynino4 field doit etre dim 2 min'
stop
endif
;
