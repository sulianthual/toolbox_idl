...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
; PROCEDURE POUR LIRE UN CHAMP DE HISTORY DE LODCA A UN PAS DE TEMPS
...
for im=0,nmodel-1 do begin
field(i,j,im)=HBM(nypl-1-j,i,im)
endfor
endfor
endfor
endif
...
for j=0,nypl-1 do begin
for im=0,nmodel-1 do begin
field(i,j,im)=UBM(nypl-1-j,i,im)
endfor
endfor
endfor
endif
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
; Ecriture de tout dans un netcdf (dernier pas de temps)
