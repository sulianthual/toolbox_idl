function myrunvar,field,wind,zeroborders=zeroborders

; Sulian THUAL oct 2009
; calcule le running var de f(t), etant donn� une fenetre wind (en indices, IMPAIR)
; renvoie fm(t) le resultat en fonction du temps (attention sur les bords quand on ne considere qu'une partie de la fenetre)
; si zeroborders est specifie, fm(t) est mis a la valeur zeroborders lorque la fenetre n'est pas complete (sur les bords)
...
print,'myrunvar error : wind non impair,return=0'
return,0
endif
;
...
fm(kt)=m2(data(index)); variance=moment d'ordre 2 centre
