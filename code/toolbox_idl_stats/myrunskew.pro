function myrunskew,field,wind,zeroborders=zeroborders

; Sulian THUAL oct 2009
; calcule le running skew de f(t), etant donné une fenetre wind (en indices, IMPAIR)
...
print,'myrunskew error : wind non impair,return=0'
return,0
endif
;
...
fm(kt)=m3(data(index)); skewness= moment d'ordre 3 centre reduit
